...
$(window).on("load", function() {
  ...
  var b = $(window);
  $(".loader-bar").animate({ width: b.width() }, 2e3),
    setTimeout(function() {
  ...
  (function() {
    // var a,
    //   b = document.getElementById("morphsearch"),
    //   e = (a = !1),
    ...
    //     e
    //       ? (classie.remove(b, "open"),
    //         setTimeout(function() {
    //           classie.add(b, "hideInput"),
    //             setTimeout(function() {
    //               classie.add(f, "p-absolute"),
    //                 classie.remove(b, "hideInput"),
    //                 (c.value = "");
    //             }, 300);
    //         }, 500),
    //         c.blur())
    //       : (classie.remove(f, "p-absolute"), classie.add(b, "open")),
    //       (e = !e);
    //   };
